...
; 1.01  11 Aug 95  NBK           GPU may not be stopped by 68k fix
;
;****************************************************************************
...
; BUG ! The GPU may ONLY STOP ITSELF !!!!
...
GPU_go:	move.l	#1,G_CTRL	; start GPU
...
go:
	move.l	#$00102400,d0		; Start at a bit before the boot track
	move.l	#BUFF_START,a0
	move.l	#BUFF_START+4096,a1	; Only load the first 4k
	move.l	#'ATRI',d1
	move.l	#11,d2
	jsr	CD_read
