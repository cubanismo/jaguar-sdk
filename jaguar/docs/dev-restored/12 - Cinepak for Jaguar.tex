...
\fancyfoot[CO]{\headerformat{Confidential \raisebox{-1pt}{\includegraphics[height=8pt]{aux/atari_jaguar_logo.pdf}} Information}}
\fancyfoot[CE]{\headerformat{Property of \raisebox{-1pt}{\includegraphics[height=8pt]{aux/atari_jaguar_logo.pdf}} Atari Corporation}}
...
\begin{technote}
\raisebox{-1.5cm}{\includegraphics[width=1.8cm]{aux/warning_triangle.pdf}}
\hspace{0.5em}
...
The \texttt{FILM\_SYNC} equate must correspond to the 4-byte partition sync marker that is repeated 16 times (for 64 bytes total) immediately before the film data begins. The player code uses this to locate the beginning of the film data after it is ready from the CD. This sync marker is inserted in front of the Jaguar Cinepak film data by the Jaguar CD Track Creator program when you create the track files for the CD.\footnote{See the Jaguar CD Mastering section of the Jaguar CD-ROM chapter for more information on the Jaguar CD Track Creator tool.} The FilmToAIFF option of the Jaguar Cinepak Utilties program always creates a sync pattern of ``1111''.\footnote{Atari recommends that you no longer use FilmToAIFF. See the Using A Jaguar Cinepak Film With CD-ROM section for more information.}
